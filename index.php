        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <button class="btn btn-danger" data-toggle="modal" data-target="#loginModal">Search Artist</button>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#loginModal">Search
                        Paintings</button>
                    <button class="btn btn-success" data-toggle="modal" data-target="#loginModal">Buy paintings</button>
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <a href="#" class="stretched-link" data-toggle="modal" data-target="#loginModal">Open</a>
                    </div>
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <p class="card-text mb-auto">As "famous" is a subjective term, CNN Style turned to Google to see
                            which paintings topped search results worldwide over the past five years.</p>
                        <a href="popular_artists.php" class="stretched-link" data-toggle="modal"
                            data-target="#loginModal">Open</a>
                    </div>
                    <div class="col-auto d-none d-lg-block">
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <p class="card-text mb-auto">As "famous" is a subjective term, CNN Style turned to Google to see
                            which paintings topped search results worldwide over the past five years.</p>
                        <a href="latest_paintings.php" class="stretched-link" data-toggle="modal"
                            data-target="#loginModal">Open</a>
                    </div>
                    <div class="col-auto d-none d-lg-block">
