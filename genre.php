            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <h3 class="mb-0">Medieval</h3>
                        <div class="mb-1 text-muted">Before 1400</div>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="200" height="250"
                            src="img/images - square and thumbnails/genres/square-medium/80.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <h3 class="mb-0">Renaissance</h3>
                        <div class="mb-1 text-muted">1400-1550</div>
                        <p class="card-text mb-auto">As "famous" is a subjective term, CNN Style turned to Google to see
                            which paintings topped search results worldwide over the past five years.</p>
                        <a href="#" class="stretched-link">Open</a>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="200" height="250"
                            src="img/images - square and thumbnails/genres/square-medium/81.jpg" alt="">
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <h3 class="mb-0">Post Renaissance</h3>
                        <div class="mb-1 text-muted">1550-1700</div>
                        <p class="card-text mb-auto">As "famous" is a subjective term, CNN Style turned to Google to see
                            which paintings topped search results worldwide over the past five years.</p>
                        <a href="#" class="stretched-link">Open</a>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="200" height="250"
                            src="img/images - square and thumbnails/genres/square-medium/83.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <h3 class="mb-0">Early Modern</h3>
                        <div class="mb-1 text-muted">1700-1875</div>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="200" height="250"
                            src="img/images - square and thumbnails/genres/square-medium/84.jpg" alt="">
        ...
        <div class="row mb-2">
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <!-- <strong class="d-inline-block mb-2 text-danger">FrontEnd</strong> -->
                        <h3 class="mb-0">Modern</h3>
                        <!-- <div class="mb-1 text-muted">1875-1945</div> -->
                        <p class="card-text mb-auto">As "famous" is a subjective term, CNN Style turned to Google to see
                            which paintings topped search results worldwide over the past five years.</p>
                        <a href="#" class="stretched-link">Open</a>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="200" height="250"
                            src="img/images - square and thumbnails/genres/square-medium/87.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <!-- <strong class="d-inline-block mb-2 text-warning">Python</strong> -->
                        <h3 class="mb-0">Contemporary</h3>
                        <div class="mb-1 text-muted">After 1945</div>
                        <p class="mb-auto">As "famous" is a subjective term, CNN Style turned to Google to see which
                            paintings topped search results worldwide over the past five years.</p>
                        <a href="#" class="stretched-link">Open</a>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="200" height="250"
                            src="img/images - square and thumbnails/genres/square-medium/88.jpg" alt="">
